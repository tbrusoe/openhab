...
import org.openhab.io.innovationhub.services.bundle.BindingConfigResource;
import org.openhab.io.innovationhub.services.chart.PersistenceResource;
import org.openhab.io.innovationhub.services.dashboard.DashboardResource;
import org.openhab.io.innovationhub.services.designer.DesignerResource;
import org.openhab.io.innovationhub.services.events.EventResource;
import org.openhab.io.innovationhub.services.icon.ItemIconResource;
import org.openhab.io.innovationhub.services.item.ItemConfigResource;
import org.openhab.io.innovationhub.services.osgi.BundleResource;
import org.openhab.io.innovationhub.services.persistence.PersistenceConfigResource;
import org.openhab.io.innovationhub.services.rule.RuleConfigResource;
import org.openhab.io.innovationhub.services.sitemap.SitemapConfigResource;
import org.openhab.io.innovationhub.services.status.StatusResource;
import org.openhab.io.innovationhub.services.zwave.ZWaveConfigResource;
 ...
 * @since 1.4.0
 */
public class innovationhubApplication extends Application  {

	public static final String innovationhub_DATA_DIR = "etc/innovationhub/";
	public static final String innovationhub_SERVLET_ALIAS = "/services/innovationhub";

	private static final Logger logger = LoggerFactory.getLogger(innovationhubApplication.class);
	...
	public void setEventPublisher(EventPublisher eventPublisher) {
		innovationhubApplication.eventPublisher = eventPublisher;
	}
	
	public void unsetEventPublisher(EventPublisher eventPublisher) {
		innovationhubApplication.eventPublisher = null;
	}
	...
	public void setItemUIRegistry(ItemUIRegistry itemUIRegistry) {
		innovationhubApplication.itemUIRegistry = itemUIRegistry;
	}
	
	public void unsetItemUIRegistry(ItemRegistry itemUIRegistry) {
		innovationhubApplication.itemUIRegistry = null;
	}
	...
	public void setModelRepository(ModelRepository modelRepository) {
		innovationhubApplication.modelRepository = modelRepository;
	}
	
	public void unsetModelRepository(ModelRepository modelRepository) {
		innovationhubApplication.modelRepository = null;
	}
	...
	public void activate() {			    
        try {
			...
			httpService.registerServlet(innovationhub_SERVLET_ALIAS,
			new AtmosphereServlet(), getJerseyServletParams(), createHttpContext());

 			logger.info("Started innovationhub REST API at " + innovationhub_SERVLET_ALIAS);
	...
	public void deactivate() {
        if (this.httpService != null) {
            httpService.unregister(innovationhub_SERVLET_ALIAS);
            logger.info("Stopped innovationhub REST API");
        }
    ...
    private Dictionary<String, String> getJerseyServletParams() {
        ...
        jerseyServletParams.put("javax.ws.rs.Application", innovationhubApplication.class.getName());
        jerseyServletParams.put("org.atmosphere.core.servlet-mapping", innovationhub_SERVLET_ALIAS + "/*");
...
//        jerseyServletParams.put("org.atmosphere.cpr.padding", "whitespace");     
    ...
    private ServiceDescription getDefaultServiceDescription() {
		...
		serviceProperties.put("uri", innovationhub_SERVLET_ALIAS);
